...
@patch.dict('os.environ', {
    ...
    'MINIO_SECURE': '1',
    'ELASTIC_ENTERPRISE_URL': 'dummy-ELASTIC_ENTERPRISE_URL',
...
def test_engine_name():
    from util.env import ENGINE_NAME, SOURCES, MINIO_HOST, MINIO_ACCESS_KEY, MINIO_SECRET_KEY, MINIO_SECURE, \
        ELASTIC_ENTERPRISE_URL, ELASTIC_APP_SEARCH_KEY
    ...
    assert ELASTIC_ENTERPRISE_URL == 'dummy-ELASTIC_ENTERPRISE_URL', "ELASTIC_ENTERPRISE_URL env should be correct"
